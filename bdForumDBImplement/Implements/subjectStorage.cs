...
namespace bdForumDBImplement.Implements
{
    ...
    {
        public TopicViewModel GetElement(subjectBindingModel model)
        {
            if (model == null)
            {
                return null;
        ...
        public List<TopicViewModel> GetFilteredList(subjectBindingModel model)
        {
        ...
        public void Insert(subjectBindingModel model)
        {
            using (var context = new ForumDatabase())
            {
                context.Topic.Add(CreateModel(model, new subject()));
                context.SaveChanges();
            }
        }
        ...
        private subject CreateModel(subjectBindingModel model, subject topic)
        {
