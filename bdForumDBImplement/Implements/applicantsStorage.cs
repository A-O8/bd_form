...
{
    public class applicantsStorage : IapplicantsStorage
    { 
        public MessageViewModel GetElement(applicantsBindingModel model)
        {
            if (model == null)
            {
                return null;
        ...
        public List<MessageViewModel> GetFilteredList(applicantsBindingModel model)
        {
            using (var context = new ForumDatabase())
            {
        ...
        public void Insert(applicantsBindingModel model)
        {
            using (var context = new ForumDatabase())
            {
                context.Message.Add(CreateModel(model, new applicants()));
                context.SaveChanges();
            }
        }
        public void Update(applicantsBindingModel model)
        {
            using (var context = new ForumDatabase())
            {
        ...
        private applicants CreateModel(applicantsBindingModel model, applicants message)
        {
