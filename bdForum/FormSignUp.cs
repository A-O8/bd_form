...
namespace bdForum
{
    public partial class FormSignUp : Form
    {
        ...
        public FormSignUp(universityLogic visitorlogic, dirictionLogic moderatorlogic)
        {
            InitializeComponent();
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            {
                visitorlogic.CreateOrUpdate(new universityBindingModel { 
            ...
            {
                moderatorlogic.CreateOrUpdate(new dirictionBindingModel
                {
                    LoginUser = textBoxLogin.Text,
                    Password = textBoxPassword.Text,
                    Email = textBoxEmail.Text, 
